...
export const ENV = {
  ...
  TWILIO_SID: process.env.TWILLO_SID_TEST,
  TWILIO_AUTH_TOKEN: process.env.TWILLO_AUTH_TOKEN_TEST,
  TWILIO_SMS_VERIFY_SERVICE: process.env.TWILLO_SMS_VERIFY_SERVICE_TEST,
